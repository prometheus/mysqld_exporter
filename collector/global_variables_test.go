...
func TestScrapeGlobalVariables(t *testing.T) {
	...
	rows := sqlmock.NewRows(columns).
		...
		AddRow("gtid_binlog_pos", "5-7-285").
		AddRow("gtid_binlog_state", "5-7-285").
		AddRow("gtid_current_pos", "0-7-30,5-7-285").
		AddRow("gtid_slave_pos", "0-7-30,5-7-285")
	...
	counterExpected := []MetricResult{
		...
		{labels: labelMap{"domain_id": "5", "server_id": "7"}, value: 285, metricType: dto.MetricType_GAUGE},
		{labels: labelMap{"domain_id": "5", "server_id": "7"}, value: 285, metricType: dto.MetricType_GAUGE},
		{labels: labelMap{"domain_id": "0", "server_id": "7"}, value: 30, metricType: dto.MetricType_GAUGE},
		{labels: labelMap{"domain_id": "5", "server_id": "7"}, value: 285, metricType: dto.MetricType_GAUGE},
		{labels: labelMap{"domain_id": "0", "server_id": "7"}, value: 30, metricType: dto.MetricType_GAUGE},
		{labels: labelMap{"domain_id": "5", "server_id": "7"}, value: 285, metricType: dto.MetricType_GAUGE},
	}
