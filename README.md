...
collect.perf_schema.replication_applier_status_by_worker     | 5.7           | Collect metrics from performance_schema.replication_applier_status_by_worker. And calculate replication lag by `NOW()-APPLYING_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP` (Need enable [parse time](parsetime))
