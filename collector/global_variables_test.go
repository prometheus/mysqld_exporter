...
func TestScrapeGlobalVariables(t *testing.T) {
	...
	rows := sqlmock.NewRows(columns).
		...
		AddRow("wsrep_start_position", "00000000-0000-0000-0000-00000000000000:-1").
	...
	counterExpected := []MetricResult{
		...
		{labels: labelMap{"wsrep_cluster_name": "supercluster", "wsrep_start_position": "00000000-0000-0000-0000-00000000000000:-1"}, value: 1, metricType: dto.MetricType_GAUGE},
