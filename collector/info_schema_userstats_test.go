...
func TestScrapeUserStat(t *testing.T) {
	...
	expected := []MetricResult{
		...
		{labels: labelMap{"user": "user_test"}, value: 767691, metricType: dto.MetricType_UNTYPED},
		{labels: labelMap{"user": "user_test"}, value: 1764, metricType: dto.MetricType_UNTYPED},
		{labels: labelMap{"user": "user_test"}, value: 8778, metricType: dto.MetricType_UNTYPED},
		{labels: labelMap{"user": "user_test"}, value: 1210741, metricType: dto.MetricType_UNTYPED},
