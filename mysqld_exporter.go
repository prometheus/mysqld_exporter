...
func newHandler(scrapers []collector.Scraper, logger *slog.Logger, config collector.Config) http.HandlerFunc {
...
func main() {
	...
	handlerFunc := newHandler(enabledScrapers, logger, collectorConfig)
