...
const (
	// prometheusSubsystem is the Metric subsystem we use.
	prometheusSubsystem = "gtid"
	prometheusName      = "executed_total"
	...
	numberOfGTIDExecutions    = "Number of GTID executions"
)
